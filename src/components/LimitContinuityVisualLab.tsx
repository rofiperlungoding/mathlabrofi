        ...
        <div className="desktop:col-span-1 space-y-6">
          ...
          <div className="card p-4">
            ...
            <div className="bg-white p-4 rounded border">
              <div className="formula-container" style={{ maxWidth: '100%' }}>
                <MathFormula 
          ...
          <div className="card p-6 h-full">
            ...
            <div className="bg-white border rounded-lg p-4 h-full flex items-center justify-center">
              <svg width="500" height="400" className="border rounded">
                ...
                <rect
                  ...
                  opacity="0.5"
                />
                <line x1="0" y1={limitY} x2="500" y2={limitY} stroke="#f59e0b" strokeWidth="2" strokeDasharray="5,5" />
                <line x1="0" y1={epsilonTop} x2="500" y2={epsilonTop} stroke="#f59e0b" strokeWidth="1" />
                <line x1="0" y1={epsilonBottom} x2="500" y2={epsilonBottom} stroke="#f59e0b" strokeWidth="1" />
                ...
                <rect
                  ...
                  opacity="0.5"
                />
                <line x1={limitX} y1="0" x2={limitX} y2="400" stroke="#3b82f6" strokeWidth="2" strokeDasharray="5,5" />
                <line x1={deltaLeft} y1="0" x2={deltaLeft} y2="400" stroke="#3b82f6" strokeWidth="1" />
                <line x1={deltaRight} y1="0" x2={deltaRight} y2="400" stroke="#3b82f6" strokeWidth="1" />
                ...
                {/* Labels */}
                <text x={limitX + 10} y={limitY - 10} className="text-sm fill-red-600 font-medium">
                  (a, L)
                </text>
                
                {/* Epsilon labels - positioned to avoid overlap */}
                <text x="20" y={epsilonTop - 10} className="text-xs fill-orange-600" textAnchor="start">
                  L + ε
                </text>
                <text x="20" y={epsilonBottom + 20} className="text-xs fill-orange-600" textAnchor="start">
                  L - ε
                </text>
                
                {/* Delta labels - positioned clearly */}
                <text x={deltaLeft} y="25" className="text-xs fill-blue-600" textAnchor="middle">
                  a - δ
                </text>
                <text x={deltaRight} y="25" className="text-xs fill-blue-600" textAnchor="middle">
                  a + δ
                </text>
                
                {/* Axis labels - positioned symmetrically */}
                <text x="480" y="195" className="text-xs fill-neutral-600" textAnchor="middle">x</text>
                <text x="260" y="20" className="text-xs fill-neutral-600" textAnchor="middle">y</text>
                
                {/* Grid labels - positioned clearly */}
                <text x="350" y="195" className="text-xs fill-neutral-500" textAnchor="middle">2</text>
                <text x="150" y="195" className="text-xs fill-neutral-500" textAnchor="middle">-2</text>
                <text x="260" y="120" className="text-xs fill-neutral-500" textAnchor="middle">2</text>
                <text x="260" y="280" className="text-xs fill-neutral-500" textAnchor="middle">-2</text>
              </svg>
            </div>
            ...
            <div className="mt-4 text-sm text-secondary">
              <div className="grid grid-cols-1 tablet:grid-cols-3 gap-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-4 h-2 bg-yellow-200 border border-yellow-400"></div>
                  <span>ε-neighborhood</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-4 h-2 bg-blue-200 border border-blue-400"></div>
